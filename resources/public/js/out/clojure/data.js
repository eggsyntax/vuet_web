...
return cljs.core.reduce.call(null,(function (result,p__29683){
...
var vec__29686 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__29686,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__29686,(1),null);
var ab = cljs.core.nth.call(null,vec__29686,(2),null);
...
clojure.data.EqualityPartition = (function (){var obj29688 = {};
return obj29688;
})();
...
return (function (){var or__15514__auto__ = (clojure.data.equality_partition[goog.typeOf(x__16158__auto__)]);
if(or__15514__auto__){
return or__15514__auto__;
} else {
var or__15514__auto____$1 = (clojure.data.equality_partition["_"]);
...
clojure.data.Diff = (function (){var obj29690 = {};
return obj29690;
})();

clojure.data.diff_similar = (function diff_similar(a,b){
if((function (){var and__15502__auto__ = a;
if(and__15502__auto__){
...
var x__16158__auto__ = (((a == null))?null:a);
return (function (){var or__15514__auto__ = (clojure.data.diff_similar[goog.typeOf(x__16158__auto__)]);
if(or__15514__auto__){
return or__15514__auto__;
} else {
var or__15514__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__15514__auto____$1){
return or__15514__auto____$1;
} else {
...
if((function (){var G__29691 = x;
if(G__29691){
var bit__16195__auto__ = (G__29691.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__16195__auto__) || (G__29691.cljs$core$IMap$)){
return true;
} else {
if((!G__29691.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__29691);
} else {
return false;
}
}
...
if((function (){var G__29692 = x;
if(G__29692){
var bit__16195__auto__ = (G__29692.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__16195__auto__) || (G__29692.cljs$core$ISet$)){
return true;
} else {
if((!G__29692.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__29692);
} else {
return false;
}
}
...
if((function (){var G__29693 = x;
if(G__29693){
var bit__16195__auto__ = (G__29693.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__16195__auto__) || (G__29693.cljs$core$ISequential$)){
return true;
} else {
if((!G__29693.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__29693);
} else {
return false;
}
}
...
return (function (){var G__29694 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__29694) {
case "map":
