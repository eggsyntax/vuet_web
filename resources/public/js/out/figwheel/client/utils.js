...
var f = (function (){var pred__34430 = cljs.core._EQ_;
var expr__34431 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34430.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34431))){
return ((function (pred__34430,expr__34431){
return (function (p1__34423_SHARP_){
return console.warn(p1__34423_SHARP_);
});
;})(pred__34430,expr__34431))
} else {
if(cljs.core.truth_(pred__34430.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34431))){
return ((function (pred__34430,expr__34431){
return (function (p1__34424_SHARP_){
return console.debug(p1__34424_SHARP_);
});
;})(pred__34430,expr__34431))
} else {
if(cljs.core.truth_(pred__34430.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34431))){
return ((function (pred__34430,expr__34431){
return (function (p1__34425_SHARP_){
return console.error(p1__34425_SHARP_);
});
;})(pred__34430,expr__34431))
} else {
return ((function (pred__34430,expr__34431){
return (function (p1__34426_SHARP_){
return console.log(p1__34426_SHARP_);
});
;})(pred__34430,expr__34431))
}
}
