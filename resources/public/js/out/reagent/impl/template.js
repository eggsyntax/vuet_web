...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16101__auto__,writer__16102__auto__,opt__16103__auto__){
return cljs.core._write.call(null,writer__16102__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23243 = o;
(G__23243[reagent.impl.template.cached_prop_name.call(null,k)] = convert_prop_value.call(null,v));
...
while (G__23245__i < G__23245__a.length) {G__23245__a[G__23245__i] = arguments[G__23245__i + 0]; ++G__23245__i;}
  args = new cljs.core.IndexedSeq(G__23245__a,0);
} 
...
var old_23247 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23247))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23247)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__15502__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23250 = jsprops;
(G__23250["defaultValue"] = value);

(G__23250["onChange"] = ((function (G__23250,v,value,on_change){
return (function (p1__23248_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23248_SHARP_);
});})(G__23250,v,value,on_change))
);
...
var vec__23252 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23252,(0),null);
var id = cljs.core.nth.call(null,vec__23252,(1),null);
var class$ = cljs.core.nth.call(null,vec__23252,(2),null);
...
var temp__4128__auto__ = (function (){var G__23254 = cljs.core.meta.call(null,v);
var G__23254__$1 = (((G__23254 == null))?null:reagent.impl.template.get_key.call(null,G__23254));
return G__23254__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23256_23257 = v;
var G__23256_23258__$1 = (((G__23256_23257 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23256_23257));
var G__23256_23259__$2 = (((G__23256_23258__$1 == null))?null:(jsprops["key"] = G__23256_23258__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__23262 = cljs.core.meta.call(null,argv);
var G__23262__$1 = (((G__23262 == null))?null:reagent.impl.template.get_key.call(null,G__23262));
return G__23262__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__23263 = (((jsprops == null))?{}:jsprops);
(G__23263["key"] = key);
...
var n__16401__auto___23264 = a.length;
var i_23265 = (0);
while(true){
if((i_23265 < n__16401__auto___23264)){
(a[i_23265] = reagent.impl.template.as_element.call(null,(a[i_23265])));
...
var a = cljs.core.into_array.call(null,s);
var n__16401__auto___23267 = a.length;
var i_23268 = (0);
while(true){
if((i_23268 < n__16401__auto___23267)){
var val_23269 = (a[i_23268]);
if((cljs.core.vector_QMARK_.call(null,val_23269)) && ((reagent.impl.template.key_from_vec.call(null,val_23269) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23268] = reagent.impl.template.as_element.call(null,val_23269));

var G__23270 = (i_23268 + (1));
i_23268 = G__23270;
continue;
} else {
}
...
var G__23272 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23272) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23272){
