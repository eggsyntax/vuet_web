...
var G__23150__delegate = function (type,props,child,children){
if(!(cljs.core.map_QMARK_.call(null,props))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1780568534,null),new cljs.core.Symbol(null,"props","props",2093813254,null)))))].join('')));
}
...
var G__23150 = function (type,props,child,var_args){
var children = null;
if (arguments.length > 3) {
var G__23151__i = 0, G__23151__a = new Array(arguments.length -  3);
while (G__23151__i < G__23151__a.length) {G__23151__a[G__23151__i] = arguments[G__23151__i + 3]; ++G__23151__i;}
  children = new cljs.core.IndexedSeq(G__23151__a,0);
} 
return G__23150__delegate.call(this,type,props,child,children);};
G__23150.cljs$lang$maxFixedArity = 3;
G__23150.cljs$lang$applyTo = (function (arglist__23152){
var type = cljs.core.first(arglist__23152);
arglist__23152 = cljs.core.next(arglist__23152);
var props = cljs.core.first(arglist__23152);
arglist__23152 = cljs.core.next(arglist__23152);
var child = cljs.core.first(arglist__23152);
var children = cljs.core.rest(arglist__23152);
return G__23150__delegate(type,props,child,children);
});
...
G__23153 = new cljs.core.IndexedSeq(G__23154__a,0);
}
return create_element__4.cljs$core$IFn$_invoke$arity$variadic(type,props,child, G__23153);
}
...
var _STAR_non_reactive_STAR_23156 = reagent.impl.component._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_23156;
}});
...
var _STAR_non_reactive_STAR_23158 = reagent.impl.component._STAR_non_reactive_STAR_;
reagent.impl.component._STAR_non_reactive_STAR_ = true;

try{return (React["renderToStaticMarkup"])(reagent.core.as_element.call(null,component));
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_23158;
}});
/**
...
var G__23159__delegate = function (x,rest){
...
while (G__23160__i < G__23160__a.length) {G__23160__a[G__23160__i] = arguments[G__23160__i + 1]; ++G__23160__i;}
  rest = new cljs.core.IndexedSeq(G__23160__a,0);
} 
return G__23159__delegate.call(this,x,rest);};
G__23159.cljs$lang$maxFixedArity = 1;
G__23159.cljs$lang$applyTo = (function (arglist__23161){
var x = cljs.core.first(arglist__23161);
var rest = cljs.core.rest(arglist__23161);
return G__23159__delegate(x,rest);
});
...
return atom__2.cljs$core$IFn$_invoke$arity$variadic(x, G__23162);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__23164__i = 0, G__23164__a = new Array(arguments.length -  2);
while (G__23164__i < G__23164__a.length) {G__23164__a[G__23164__i] = arguments[G__23164__i + 2]; ++G__23164__i;}
  args = new cljs.core.IndexedSeq(G__23164__a,0);
} 
return wrap__delegate.call(this,value,reset_fn,args);};
wrap.cljs$lang$maxFixedArity = 2;
wrap.cljs$lang$applyTo = (function (arglist__23165){
var value = cljs.core.first(arglist__23165);
arglist__23165 = cljs.core.next(arglist__23165);
var reset_fn = cljs.core.first(arglist__23165);
...
partial.cljs$lang$applyTo = (function (arglist__23167){
